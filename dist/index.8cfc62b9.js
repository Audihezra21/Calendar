...
function initCalendar() {
    ...
    for(let i = 1; i <= lastDate; i++){
        ...
        } else days += `<div class="day${event ? " event" : ""}">${i}</div>`;
    }
        ...
        day.addEventListener("click", (e)=>{
            ...
            if (e.target.classList.contains("prev-date")) {
                ...
                setTimeout(()=>{
                    ...
                    const days = document.querySelectorAll(".day");
                    days.forEach((day)=>{
                        if (!day.classList.contains("prev-date") && day.innerHTML === e.target.innerHTML) day.classList.add("active");
                    });
                }, 100);
                ...
                setTimeout(()=>{
                    const days = document.querySelectorAll(".day");
                    days.forEach((day)=>{
                        if (!day.classList.contains("next-date") && day.innerHTML === e.target.innerHTML) day.classList.add("active");
                    });
                }, 100);
...
dateInput.addEventListener("input", (e)=>{
    ...
    if (e.inputType === "deleteContentBackward") {
        if (dateInput.value.length === 3) dateInput.value = dateInput.value.slice(0, 2);
    }
});
...
function updateEvents(date) {
    ...
    eventsArr.forEach((event)=>{
        if (date === event.day && month + 1 === event.month && year === event.year) events += `<div class="event">
          <div class="title">
    ...
    if (events === "") events = `<div class="no-event">
        <h3>No Events</h3>
    </div>`;
...
document.addEventListener("click", (e)=>{
    if (e.target !== addEventBtn && !addEventWrapper.contains(e.target)) addEventWrapper.classList.remove("active");
});
...
async function deleteEvent(id) {
    const { data, error } = await supabase.from("events").delete().match({
        id
    });
...
},{"./lib/constants":"jdaS4","./lib/serializer":"4eoeK","./lib/timer":"2kNsn","./lib/transformers":"iXNeD","./RealtimeChannel":"7VOkr","3ea8640035012c43":"43ht9","c4dfe9bfdd39a2b7":"dMAIu","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"jdaS4":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"dMAIu":[function(require,module,exports) {
module.exports = require("d6269c0b45f448da")(require("678efc72b9b695a1").getBundleURL("fqV6O") + "browser.7ada82ab.js" + "?" + Date.now()).catch((err)=>{
    delete module.bundle.cache[module.id];
    throw err;
}).then(()=>module.bundle.root("4OuWD"));

},{"d6269c0b45f448da":"61B45","678efc72b9b695a1":"lgJ39"}],"61B45":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["86oZd","6rimH"], "6rimH", "parcelRequire94c2")
